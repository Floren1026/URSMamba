...
parser.add_argument('--trainpics', default='./training_rgb/',
                    help='folder to output training images')
parser.add_argument('--validationpics', default='./training_rgb/',
                    help='folder to output validation images')
parser.add_argument('--testPics', default='./training_rgb/',
                    help='folder to output test images')
parser.add_argument('--outckpts', default='./training_rgb/',
                    help='folder to output checkpoints')
parser.add_argument('--outlogs', default='./training_rgb/',
                    help='folder to output images')
parser.add_argument('--outcodes', default='./training_rgb/',
...
def main():
    ...
    # if args.dyt:
    #     Hnet = convert_ln_to_dyt(Hnet)
    #     Rnet = convert_ln_to_dyt(Rnet)
    ...
    if args.train_continue:
        checkpoint_h = f"./training_rgb/{args.Model_dir}/checkPoints/checkpointH.pt"
        checkpoint_r = f"./training_rgb/{args.Model_dir}/checkPoints/checkpointR.pt"
    ...
    # write the networks
    writer = SummaryWriter(log_dir='runs_rgb/' + args.experiment_dir)
